            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-laptop me-2"></i>Catogaties</a>
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="AddCat.php" class="dropdown-item">Add Catogary</a>
                            <a href="viewcatogary.php" class="dropdown-item">view Catogary</a>
